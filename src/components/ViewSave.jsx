...
const ViewSave = () => {
  ...
  return (
    <div className="mt-1 flex flex-col justify-center items-center min-h-fit  p-3">
      <div className="flex mr-4  flex-col items-center min-h-screen w-full max-w-4xl p-4">
        ...
        <div className="w-full ml-3 relative">
          <textarea
            className="m-2 w-full rounded-lg bg-black text-white p-4 px-6 resize-none overflow-auto focus:border-[#4b5563] focus:outline-none focus:ring-0 custom-scrollbar"
            rows={20}
            value={note.content}
            disabled
          ...
          <button
            onClick={handleCopy}
            className="absolute top-4 right-1  text-white px-1 py-1 rounded-md  hover:bg-[#181a1b]
              transition-colors duration-300"
